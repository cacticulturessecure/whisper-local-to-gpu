...
class DevEnvironmentTester:
    ...
    def test_ollama_chat(self) -> Dict[str, Any]:
        """Test Ollama chat functionality with specific business context"""
        try:
            chat_payload = {
                "model": "llama3.1:70b",
                "messages": [
            ...
            console.print(Panel(
                ...
                "System: Fastly Solutions Engineer\n"
                "User: Ashley Furniture VP\n"
